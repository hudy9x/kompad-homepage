    ...
    <>
      <FeatureBox
        ...
        desc={
          <>
            <p className="pb-2">
              Diplays sequence diagram in preview mode. Easy to update and
            ...
            <p>
              ...
              <a
                ...
                target={"_blank"}
                rel="noreferrer"
                href="https://mermaid-js.github.io/mermaid/syntax/sequenceDiagram.html"
              >
