    ...
    <>
      ...
      <div id="pricing-plan" className="pt-32 pb-20 border-b border-gray-300">
        <div className="main-box">
          <h2 className="title2">
            <span className="text-indigo-500">Pricing</span> plans
          </h2>
          <p className="px-8 text-center md:px-0 md:w-[600px] m-auto mt-6">
            Start taking note for free in 15 days, then add a plan to unlock
            additional features
          </p>
          <div className="pricing-table mt-10 text-center">
            ...
            <div className="pricing-items">
              {pricingItems.map((item) => {
                ...
                return (
                  <div className="pricing-item" key={item.title}>
                    <div className="space-y-5">
                      ...
                      >
                        {item.btnTitle ? item.btnTitle : `Buy ${item.title}`}
                      </button>
                    </div>
            ...
            <p className="px-8 text-center md:px-0 md:w-[600px] m-auto">
              Payment method support: Paypal, Bank
            </p>
          </div>
        </div>
      </div>
