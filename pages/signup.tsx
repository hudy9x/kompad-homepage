...
import { HiOutlineCalendar, HiOutlineGlobe, HiOutlineLockClosed, HiOutlineMail, HiOutlineUser, HiOutlineX } from "react-icons/hi";
...
export default function Signup() {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      password: "",
      address: "",
      photoURL: "https://firebasestorage.googleapis.com/v0/b/kompad-a9b60.appspot.com/o/avatars%2Fpublic%2Fmen-6.png?alt=media&token=37e2e899-6cbb-4ed3-b2d8-b3fcb86dedad",
    ...
    <div id="signin" className="bg-pattern-1 h-screen">
      ...
      <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-[350px] sm:max-w-md">
          ...
          {errorMess ? <p className="bg-red-200 rounded-md mt-3 shadow-lg text-red-700 p-4 relative">
            <HiOutlineX 
              onClick={() => { setErrorMess("") }}
        ...
        <div className="mt-8 sm:mx-auto sm:w-[350px] sm:max-w-md">
          ...
          <form className="sign-form space-y-3" onSubmit={formik.handleSubmit}>
